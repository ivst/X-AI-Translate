(function (root) {
  ...
  "ar": {
    ...
    "api_base_url_deepl": "رابط API الأساسي لـ DeepL",
    "api_base_url_placeholder_deepl": "https://api-free.deepl.com",
    "api_key": "مفتاح API",
    ...
    "deepseek_thinking": "تفعيل وضع التفكير في DeepSeek",
    "deepseek_thinking_hint": "يحسّن الاستدلال في المهام المعقدة، لكنه قد يجعل الترجمات أبطأ.",
    ...
    "enable_x_auto_translation": "ترجمة المنشورات الظاهرة تلقائيًا على X",
    "enable_youtube_auto_translation": "ترجمة التعليقات الظاهرة تلقائيًا على YouTube",
    "save": "حفظ",
  ...
  "zh": {
    ...
    "api_base_url_placeholder": "https://api.openai.com/v1",
    "api_base_url_deepl": "DeepL API 基础 URL",
    "api_base_url_placeholder_deepl": "https://api-free.deepl.com",
    "api_key": "API 密钥",
    "api_key_placeholder": "sk-...",
    "model": "模型",
    ...
    "deepseek_thinking": "启用 DeepSeek 思考模式",
    "deepseek_thinking_hint": "可提高复杂任务的推理质量，但可能使翻译变慢。",
    "target_lang": "目标语言",
    "source_lang": "源语言",
    "autodetect": "自动检测",
    "output_mode": "右键菜单输出",
    ...
    "enable_x_auto_translation": "自动翻译 X 上可见的帖子",
    "enable_youtube_auto_translation": "自动翻译 YouTube 上可见的评论",
    "save": "保存",
  ...
  "en": {
    ...
    "subscription_status_not_verified": "Install the Bridge and sign in to the provider CLI",
    "subscription_status_login_started": "Login started in the local bridge.",
    "subscription_hint": "Install the separate Bridge once to connect in the background.",
    "subscription_connect": "Connect",
    "subscription_disconnect": "Disconnect",
    "subscription_help": "How to start the bridge",
    "subscription_instructions_title": "Set up OpenAI/Claude subscription access",
    "subscription_instructions_subtitle": "Install the separate Bridge once; the extension connects to its local background service.",
    "subscription_instructions_provider_openai": "OpenAI uses the authenticated Codex CLI.",
    "subscription_instructions_provider_claude": "Claude uses the authenticated Claude Code CLI.",
    "subscription_instructions_step_install": "Install the CLI for the selected provider.",
    "subscription_instructions_step_login": "Sign in to the provider account.",
    "subscription_instructions_step_bridge": "Download and install the AI Translate Bridge bundle for your operating system from the documentation.",
    "subscription_instructions_step_connect": "Return here, select Subscription, and click Connect. No terminal is needed after installation.",
    "subscription_instructions_note": "The extension does not install or execute external files. After the one-time bridge installation, it runs in the background. API-key mode remains available at any time.",
    "subscription_instructions_docs": "Open bridge documentation",
    "subscription_instructions_open_tab": "Open full instructions",
    "subscription_instructions_close": "Close",
    "subscription_instructions_back": "Back to settings",
    ...
    "deepseek_thinking": "Enable DeepSeek thinking mode",
    "deepseek_thinking_hint": "Improves reasoning for complex tasks, but may make translations slower.",
    ...
    "enable_x_auto_translation": "Automatically translate visible posts on X",
    "enable_youtube_auto_translation": "Automatically translate visible comments on YouTube",
    "save": "Save",
  ...
  "fr": {
    ...
    "api_base_url_placeholder": "https://api.openai.com/v1",
    "api_base_url_deepl": "URL de base de l’API DeepL",
    "api_base_url_placeholder_deepl": "https://api-free.deepl.com",
    "api_key": "Clé API",
    "api_key_placeholder": "sk-...",
    "model": "Modèle",
    ...
    "deepseek_thinking": "Activer le mode réflexion de DeepSeek",
    "deepseek_thinking_hint": "Améliore le raisonnement pour les tâches complexes, mais peut ralentir les traductions.",
    ...
    "enable_x_auto_translation": "Traduire automatiquement les publications visibles sur X",
    "enable_youtube_auto_translation": "Traduire automatiquement les commentaires visibles sur YouTube",
    "save": "Enregistrer",
  ...
  "de": {
    ...
    "api_base_url_placeholder": "https://api.openai.com/v1",
    "api_base_url_deepl": "DeepL-API-Basis-URL",
    "api_base_url_placeholder_deepl": "https://api-free.deepl.com",
    ...
    "deepseek_thinking": "DeepSeek-Denkmodus aktivieren",
    "deepseek_thinking_hint": "Verbessert die Antworten bei komplexen Aufgaben, kann Übersetzungen aber verlangsamen.",
    ...
    "enable_x_auto_translation": "Sichtbare Beiträge auf X automatisch übersetzen",
    "enable_youtube_auto_translation": "Sichtbare Kommentare auf YouTube automatisch übersetzen",
    "save": "Speichern",
  ...
  "el": {
    ...
    "api_base_url_placeholder": "https://api.openai.com/v1",
    "api_base_url_deepl": "Βασικό URL API DeepL",
    "api_base_url_placeholder_deepl": "https://api-free.deepl.com",
    "api_key": "Κλειδί API",
    "api_key_placeholder": "sk-...",
    "model": "Μοντέλο",
    ...
    "deepseek_thinking": "Ενεργοποίηση λειτουργίας σκέψης DeepSeek",
    "deepseek_thinking_hint": "Βελτιώνει τη συλλογιστική σε σύνθετες εργασίες, αλλά μπορεί να κάνει τις μεταφράσεις πιο αργές.",
    ...
    "enable_x_auto_translation": "Αυτόματη μετάφραση ορατών αναρτήσεων στο X",
    "enable_youtube_auto_translation": "Αυτόματη μετάφραση ορατών σχολίων στο YouTube",
    "save": "Αποθήκευση",
  ...
  "he": {
    ...
    "api_base_url_placeholder": "https://api.openai.com/v1",
    "api_base_url_deepl": "כתובת בסיס API של DeepL",
    "api_base_url_placeholder_deepl": "https://api-free.deepl.com",
    "api_key": "מפתח API",
    "api_key_placeholder": "sk-...",
    "model": "מודל",
    ...
    "deepseek_thinking": "הפעלת מצב החשיבה של DeepSeek",
    "deepseek_thinking_hint": "משפר את ההיגיון במשימות מורכבות, אך עלול להאט את התרגומים.",
    "target_lang": "שפת יעד",
    ...
    "enable_x_auto_translation": "תרגום אוטומטי של פוסטים גלויים ב-X",
    "enable_youtube_auto_translation": "תרגום אוטומטי של תגובות גלויות ב-YouTube",
    "save": "שמור",
  ...
  "it": {
    ...
    "api_base_url_placeholder": "https://api.openai.com/v1",
    "api_base_url_deepl": "URL base API DeepL",
    "api_base_url_placeholder_deepl": "https://api-free.deepl.com",
    "api_key": "Chiave API",
    "api_key_placeholder": "sk-...",
    "model": "Modello",
    ...
    "deepseek_thinking": "Abilita la modalità di ragionamento DeepSeek",
    "deepseek_thinking_hint": "Migliora il ragionamento nelle attività complesse, ma può rallentare le traduzioni.",
    ...
    "enable_x_auto_translation": "Traduci automaticamente i post visibili su X",
    "enable_youtube_auto_translation": "Traduci automaticamente i commenti visibili su YouTube",
    "save": "Salva",
  ...
  "ja": {
    ...
    "api_base_url_placeholder": "https://api.openai.com/v1",
    "api_base_url_deepl": "DeepL API ベースURL",
    "api_base_url_placeholder_deepl": "https://api-free.deepl.com",
    "api_key": "APIキー",
    "api_key_placeholder": "sk-...",
    "model": "モデル",
    ...
    "deepseek_thinking": "DeepSeek の思考モードを有効化",
    "deepseek_thinking_hint": "複雑なタスクでの推論を改善しますが、翻訳が遅くなる場合があります。",
    "target_lang": "翻訳先言語",
    "source_lang": "原文言語",
    "autodetect": "自動検出",
    ...
    "enable_x_auto_translation": "X の表示中の投稿を自動翻訳",
    "enable_youtube_auto_translation": "YouTube の表示中のコメントを自動翻訳",
    "save": "保存",
  ...
  "ko": {
    ...
    "api_base_url_placeholder": "https://api.openai.com/v1",
    "api_base_url_deepl": "DeepL API 기본 URL",
    "api_base_url_placeholder_deepl": "https://api-free.deepl.com",
    "api_key": "API 키",
    "api_key_placeholder": "sk-...",
    "model": "모델",
    ...
    "deepseek_thinking": "DeepSeek 사고 모드 사용",
    "deepseek_thinking_hint": "복잡한 작업의 추론을 개선하지만 번역이 느려질 수 있습니다.",
    "target_lang": "대상 언어",
    "source_lang": "원본 언어",
    "autodetect": "자동 감지",
    ...
    "enable_x_auto_translation": "X의 보이는 게시물 자동 번역",
    "enable_youtube_auto_translation": "YouTube의 보이는 댓글 자동 번역",
    "save": "저장",
  ...
  "pt": {
    ...
    "api_base_url_placeholder": "https://api.openai.com/v1",
    "api_base_url_deepl": "URL base da API DeepL",
    "api_base_url_placeholder_deepl": "https://api-free.deepl.com",
    ...
    "deepseek_thinking": "Ativar modo de raciocínio do DeepSeek",
    "deepseek_thinking_hint": "Melhora o raciocínio em tarefas complexas, mas pode deixar as traduções mais lentas.",
    ...
    "enable_x_auto_translation": "Traduzir automaticamente as publicações visíveis no X",
    "enable_youtube_auto_translation": "Traduzir automaticamente os comentários visíveis no YouTube",
    "save": "Salvar",
  ...
  "ru": {
    ...
    "subscription_status_not_verified": "Установите Bridge и войдите в CLI провайдера",
    "subscription_status_login_started": "Вход запущен в локальном bridge.",
    "subscription_hint": "Один раз установите отдельный Bridge для фонового подключения.",
    "subscription_connect": "Подключить",
    "subscription_disconnect": "Отключить",
    "subscription_help": "Как запустить bridge",
    "subscription_instructions_title": "Настройка доступа к подпискам OpenAI/Claude",
    "subscription_instructions_subtitle": "Установите отдельный Bridge один раз — расширение будет подключаться к его локальному фоновому сервису.",
    "subscription_instructions_provider_openai": "Для OpenAI используется авторизованный Codex CLI.",
    "subscription_instructions_provider_claude": "Для Claude используется авторизованный Claude Code CLI.",
    "subscription_instructions_step_install": "Установите CLI выбранного провайдера.",
    "subscription_instructions_step_login": "Войдите в аккаунт провайдера.",
    "subscription_instructions_step_bridge": "Скачайте и установите bundle AI Translate Bridge для вашей ОС по ссылке в документации.",
    "subscription_instructions_step_connect": "Вернитесь сюда, выберите «Подписка» и нажмите «Подключить». После установки терминал не нужен.",
    "subscription_instructions_note": "Расширение не устанавливает и не запускает внешние файлы. После однократной установки bridge он работает в фоне. Режим API-ключа всегда доступен.",
    "subscription_instructions_docs": "Открыть документацию bridge",
    "subscription_instructions_open_tab": "Открыть полную инструкцию",
    "subscription_instructions_close": "Закрыть",
    "subscription_instructions_back": "Вернуться в настройки",
    ...
    "deepseek_thinking": "Включить режим рассуждений DeepSeek",
    "deepseek_thinking_hint": "Улучшает рассуждения в сложных задачах, но может замедлить перевод.",
    ...
    "enable_x_auto_translation": "Автоматически переводить видимые посты в X",
    "enable_youtube_auto_translation": "Автоматически переводить видимые комментарии на YouTube",
    "save": "Сохранить",
  ...
  "es": {
    ...
    "api_base_url_placeholder": "https://api.openai.com/v1",
    "api_base_url_deepl": "URL base de la API de DeepL",
    "api_base_url_placeholder_deepl": "https://api-free.deepl.com",
    "api_key": "Clave API",
    "api_key_placeholder": "sk-...",
    "model": "Modelo",
    ...
    "deepseek_thinking": "Activar el modo de razonamiento de DeepSeek",
    "deepseek_thinking_hint": "Mejora el razonamiento en tareas complejas, pero puede ralentizar las traducciones.",
    "target_lang": "Idioma de destino",
    ...
    "enable_x_auto_translation": "Traducir automáticamente las publicaciones visibles en X",
    "enable_youtube_auto_translation": "Traducir automáticamente los comentarios visibles en YouTube",
    "save": "Guardar",
  ...
  "th": {
    ...
    "api_base_url_placeholder": "https://api.openai.com/v1",
    "api_base_url_deepl": "URL พื้นฐาน API ของ DeepL",
    "api_base_url_placeholder_deepl": "https://api-free.deepl.com",
    "api_key": "API Key",
    "api_key_placeholder": "sk-...",
    "model": "โมเดล",
    ...
    "deepseek_thinking": "เปิดโหมดคิดของ DeepSeek",
    "deepseek_thinking_hint": "ช่วยปรับปรุงการให้เหตุผลในงานซับซ้อน แต่อาจทำให้การแปลช้าลง",
    ...
    "enable_x_auto_translation": "แปลโพสต์ที่มองเห็นบน X โดยอัตโนมัติ",
    "enable_youtube_auto_translation": "แปลความคิดเห็นที่มองเห็นบน YouTube โดยอัตโนมัติ",
    "save": "บันทึก",
  ...
  "tr": {
    ...
    "api_base_url_placeholder": "https://api.openai.com/v1",
    "api_base_url_deepl": "DeepL API temel URL'si",
    "api_base_url_placeholder_deepl": "https://api-free.deepl.com",
    ...
    "deepseek_thinking": "DeepSeek düşünme modunu etkinleştir",
    "deepseek_thinking_hint": "Karmaşık görevlerde akıl yürütmeyi iyileştirir, ancak çevirileri yavaşlatabilir.",
    ...
    "enable_x_auto_translation": "X'te görünen gönderileri otomatik çevir",
    "enable_youtube_auto_translation": "YouTube'da görünen yorumları otomatik çevir",
    "save": "Kaydet",
  ...
  "uk": {
    ...
    "api_base_url_placeholder": "https://api.openai.com/v1",
    "api_base_url_deepl": "Базовий URL API DeepL",
    "api_base_url_placeholder_deepl": "https://api-free.deepl.com",
    "api_key": "API ключ",
    "api_key_placeholder": "sk-...",
    "model": "Модель",
    ...
    "deepseek_thinking": "Увімкнути режим міркування DeepSeek",
    "deepseek_thinking_hint": "Покращує міркування у складних завданнях, але може сповільнити переклад.",
    ...
    "enable_x_auto_translation": "Автоматично перекладати видимі дописи в X",
    "enable_youtube_auto_translation": "Автоматично перекладати видимі коментарі на YouTube",
    "save": "Зберегти",
