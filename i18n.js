(function (root) {
  ...
  "en": {
    ...
    "subscription_instructions_step_bridge": "Open a terminal in the downloaded bridge folder and run the command below.",
    "subscription_instructions_step_connect": "Return here, select Subscription, and click Connect.",
    "subscription_instructions_note": "The extension does not run shell commands. Keep the bridge terminal open while using subscription mode. API-key mode remains available at any time.",
  ...
  "ru": {
    ...
    "subscription_instructions_step_bridge": "Откройте терминал в скачанной папке bridge и выполните команду ниже.",
    "subscription_instructions_step_connect": "Вернитесь сюда, выберите «Подписка» и нажмите «Подключить».",
    "subscription_instructions_note": "Расширение не выполняет shell-команды. Оставляйте терминал с bridge открытым во время работы в режиме подписки. Режим API-ключа всегда доступен.",
