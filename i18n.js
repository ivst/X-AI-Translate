(function (root) {
  ...
  "en": {
    ...
    "subscription_instructions_step_bridge": "From the extension repository root, start the local bridge.",
    "subscription_instructions_step_connect": "Return here, select Subscription, and click Connect.",
    "subscription_instructions_note": "Keep the bridge terminal running while using subscription mode. API-key mode remains available at any time.",
  ...
  "ru": {
    ...
    "subscription_instructions_step_bridge": "Из корня репозитория расширения запустите локальный bridge.",
    "subscription_instructions_step_connect": "Вернитесь сюда, выберите «Подписка» и нажмите «Подключить».",
    "subscription_instructions_note": "Оставляйте терминал с bridge запущенным во время работы в режиме подписки. Режим API-ключа всегда доступен.",
