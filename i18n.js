(function (root) {
  ...
  "en": {
    ...
    "subscription_hint": "Install and start the local subscription bridge to connect.",
    "subscription_connect": "Connect",
    "subscription_disconnect": "Disconnect",
    "subscription_help": "How to start the bridge",
    "subscription_instructions_title": "How to start the subscription bridge",
    "subscription_instructions_subtitle": "The bridge runs locally and uses the provider CLI session.",
  ...
  "ru": {
    ...
    "subscription_hint": "Установите и запустите локальный bridge подписок для подключения.",
    "subscription_connect": "Подключить",
    "subscription_disconnect": "Отключить",
    "subscription_help": "Как запустить bridge",
    "subscription_instructions_title": "Как запустить bridge подписок",
    "subscription_instructions_subtitle": "Bridge работает локально и использует сессию CLI выбранного провайдера.",
