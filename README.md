...
## Privacy
Selected text and X posts or YouTube comments you manually request to translate are sent only to the API endpoint you configure. When enabled, visible X posts and YouTube comments are also sent to that endpoint for automatic translation.
