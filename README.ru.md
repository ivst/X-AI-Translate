...
Режим подписки включается вручную и требует локального bridge и авторизованного CLI провайдера. Перед выбором режима «Подписка» выполните инструкции в [`bridge/README.md`](bridge/README.md). Gemini и остальные провайдеры продолжают работать через существующий режим API-ключа.
